...
train_loader = torch.utils.data.DataLoader(
   ...
   transform=data_jitter_brightness),datasets.ImageFolder(dataPath + '/train',
   transform=data_jitter_hue),datasets.ImageFolder(dataPath + '/train',
   transform=data_jitter_contrast),datasets.ImageFolder(dataPath + '/train',
   transform=data_jitter_saturation),datasets.ImageFolder(dataPath + '/train',
   transform=data_translate),datasets.ImageFolder(dataPath + '/train',
   transform=data_rotate),datasets.ImageFolder(dataPath + '/train',
   transform=data_hvflip),datasets.ImageFolder(dataPath + '/train',
   transform=data_center),datasets.ImageFolder(dataPath + '/train',
   transform=data_shear)]), batch_size=batch_size, shuffle=True, num_workers=0, pin_memory=use_gpu)
